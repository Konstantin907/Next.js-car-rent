"use client"; //zbog headless-a
import { CarProps } from "@/types";
import Image from "next/image";
import { Fragment } from "react";
import {Dialog, Transition} from "@headlessui/react"

//Dialog je za modal kada se klikne koji se otvor
//a Transition je za malu tranziciju koja se 
//nekoliko sekundi linepo pokrece za modal
        ...
        <Transition appear show={isOpen}
            as={Fragment}>
                ...
                onClose={closeModal}>
                    ...
                    >
                        ...
                        max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white 
            ...
            <div className="flex-1 flex flex-col gap-3">
                ...
                bg-cover bg-center rounded-lg">
                    ...
                    alt="model" className="object-contain" />
                </div>
...
{/* Car kartica detalji, entries za mapovanje i keys i values */}
